...
function loadSuppliers() {
    const saved = localStorage.getItem('billhive-suppliers');
    if (saved) {
        try {
...
function saveSuppliersStorage() {
    localStorage.setItem('billhive-suppliers', JSON.stringify(Suppliers));
}
